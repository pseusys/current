...
void MainWindow::read_from_file() {
    ...
    int result = lab5::launch(ui->canvas1, ui->canvas2, &input, true, ui->type_selector->currentIndex(), ui->step_box->isChecked());
...
void MainWindow::read_from_line() {
    std::string input = ui->line_input->text().toStdString();
    int result = lab5::launch(ui->canvas1, ui->canvas2, &input, false, ui->type_selector->currentIndex(), ui->step_box->isChecked());
...
void MainWindow::step() {
    ...
    switch (lab5::type) {
        case 0:
            result = lab5::launch_steps<int>(ui->canvas1, ui->canvas2);
            break;
        case 1:
            result = lab5::launch_steps<char>(ui->canvas1, ui->canvas2);
            break;
        case 2:
            result = lab5::launch_steps<double>(ui->canvas1, ui->canvas2);
            break;
        case 3:
            result = lab5::launch_steps<std::string>(ui->canvas1, ui->canvas2);
            break;
    }
...
void MainWindow::step_forward() {
    ...
    switch (lab5::type) {
        case 0:
            result = lab5::step<std::string>(ui->canvas1);
            break;
        case 1:
            result = lab5::step<char>(ui->canvas1);
            break;
        case 2:
            result = lab5::step<int>(ui->canvas1);
            break;
        case 3:
            result = lab5::step<double>(ui->canvas1);
            break;
    }
...
void MainWindow::rush_forward() {
    ...
    switch (lab5::type) {
        case 0:
            result = lab5::rush<std::string>(ui->canvas1);
            break;
        case 1:
            result = lab5::rush<char>(ui->canvas1);
            break;
        case 2:
            result = lab5::rush<int>(ui->canvas1);
            break;
        case 3:
            result = lab5::rush<double>(ui->canvas1);
            break;
    }
...
void MainWindow::mult_forward() {
    ...
    switch (lab5::type) {
        case 0:
            result = lab5::mult<std::string>(ui->canvas1);
            break;
        case 1:
            result = lab5::mult<char>(ui->canvas1);
            break;
        case 2:
            result = lab5::mult<int>(ui->canvas1);
            break;
        case 3:
            result = lab5::mult<double>(ui->canvas1);
            break;
    }
