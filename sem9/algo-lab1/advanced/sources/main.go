...
var (
	...
	image    = flag.String("n", DEF_IMAGE_NAME, "Output image base name")
	format   = flag.String("f", BINARY_FORMAT, "Output image format, should be either 'ppm' or 'svg'")
	size     = flag.String("s", DEF_SIZE, "Size of maze, formatted like [WIDTH]x[HEIGHT]")
	path     = flag.Bool("p", DEF_PATH, "Calculate and draw path from entrance to exit")
	route    = flag.String("r", DEF_ROUTE_NAME, "Output path base name")
	...
	verbose  = flag.Bool("v", DEF_VERBOSE, "Print intermediate output")
