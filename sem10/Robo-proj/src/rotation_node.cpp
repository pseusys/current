...
#define rotation_error_threshold M_PI/18 //radians = 10 degres
...
void compute_rotation()
{
    ...
    //	rotation_done = -M_PI + (rotation_done - M_PI);
    //}
    ...
    cond_rotation = abs(error_rotation) > rotation_error_threshold; // cond_rotation is used to control if we stop or not the pid
