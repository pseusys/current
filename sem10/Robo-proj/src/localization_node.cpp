...
void initialize_localization() {
    ...
    float rad_in_5_deg = 5.0/180*M_PI;
    int max_score = 0;
...
// NOTHING TO DO HERE
    ...
    ROS_INFO("predict_position done: (%f, %f, %f)", estimated_position.x, estimated_position.y, estimated_orientation*180/M_PI);
...
// initialize_localization should work before you implement this method
    ...
    min_orientation = - M_PI / 6;
    max_orientation = + M_PI / 6;
    ...
    ROS_INFO("estimate_position done: (%f, %f, %f)", estimated_position.x, estimated_position.y, estimated_orientation*180/M_PI);
